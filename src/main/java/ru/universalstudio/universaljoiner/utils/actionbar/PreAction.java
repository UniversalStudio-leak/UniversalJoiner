...
public class PreAction {
  ...
  public PreAction(Player paramPlayer, String paramString) throws ClassNotFoundException {
    try {
      ...
      Object object3 = getNMSClass("PacketPlayOutChat").getConstructor(new Class[] { getNMSClass("IChatBaseComponent"), getNMSClass("ChatMessageType"), Class.forName("java.util.UUID") }).newInstance(new Object[] { object1, object2, paramPlayer.getUniqueId() });
